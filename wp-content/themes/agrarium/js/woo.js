...
(function (jQuery) {
  ...
  function custom_quantity() {
    jQuery(".quantity-wrapper").each(function () {
      if (
        !jQuery(".quantity", this).hasClass("hidden") &&
        (jQuery(".btn-minus", this).length === 0 ||
          jQuery(".btn-plus", this).length === 0)
      ) {
        jQuery(this)
          .addClass("styled")
  ...
  jQuery(document).ready(function () {
    ...
    jQuery("form.checkout").on(
      "change",
      'select.shipping_method, input[name^="shipping_method"], #ship-to-different-address input, .update_totals_on_change select, .update_totals_on_change input[type="radio"], .update_totals_on_change input[type="checkbox"], select[name="billing_country"], select[name="shipping_country"], input[name="ship_to_different_address"]',
      function () {
    ...
    jQuery("form.checkout").on(
      "change",
      'select[name="shipping_country"], select[name="billing_country"], input[name="ship_to_different_address"]',
      function () {
    ...
    jQuery(document.body).on("updated_checkout", function () {
      if (
        !jQuery(".woocommerce-checkout-shipping-method .select2").hasClass(
    ...
    jQuery(document.body).on(
      "change",
      'select[name="billing_country"], select[name="shipping_country"], input[name="ship_to_different_address"]',
      function () {
